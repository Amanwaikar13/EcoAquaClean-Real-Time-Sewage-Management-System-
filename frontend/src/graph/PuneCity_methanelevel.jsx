...
const PuneCity_methanelevel = () => {
  ...
  return <div ref={graphRef} style={{ width: '60%', position: 'absolute', bottom: 0,left:140,top:1250}}></div>;
};

export default PuneCity_methanelevel;
